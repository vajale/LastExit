...
{
    public class PlayerCharacter : IControllablePlayableCharacter
    {
        ...
        public PlayerCharacter(UnitBody unitBody, IPlayerMoveController moveController, IInventory inventory)
        {
